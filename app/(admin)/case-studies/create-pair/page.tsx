...
// ─── Image Upload Field ───────────────────────────────────────────────────────
function ImageUploadField({ label, imageUrl, onUpload, slug, bucket = 'case_studies' }: { label: string; imageUrl: string; onUpload: (url: string) => void; slug: string; bucket?: StorageBucket }) {
