    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {/* Published Blogs */}
                <Link href="/admin/blogs" className="block transition-transform hover:scale-[1.02]">
                ...
                {/* Case Studies */}
                <Link href="/admin/case-studies" className="block transition-transform hover:scale-[1.02]">
                    <div className="admin-card p-6 bg-gradient-to-br from-[#00A99D]/10 to-white border-l-4 border-[#00A99D] h-full">
                        <div className="flex items-center justify-between">
                            <div>
                ...
                {/* Unread Contacts */}
                <Link href="/admin/contacts" className="block transition-transform hover:scale-[1.02]">
                ...
                {/* Active Jobs */}
                <Link href="/admin/careers" className="block transition-transform hover:scale-[1.02]">
